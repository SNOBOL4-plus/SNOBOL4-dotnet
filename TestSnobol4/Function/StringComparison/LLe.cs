...
";
    ...
    [TestMethod]
    public void TEST_LLe_006_ordinal_upper_le_lower()
    {
        // Ordinal: 'A'=65 <= 'a'=97 — lle('A','a') must SUCCEED
        var s = @"
        r = 'success'
        lle('A', 'a') :s(end)
        r = 'failure'
...
";
    ...
    [TestMethod]
    public void TEST_LLe_007_null_le_null()
    {
        // lle('','') must SUCCEED — null <= null
        var s = @"
        r = 'success'
        lle('', '') :s(end)
        r = 'failure'
...
";
    ...
    [TestMethod]
    public void TEST_LLe_008_null_le_nonempty()
    {
        // lle('','z') must SUCCEED — null < any nonempty
        var s = @"
        r = 'success'
        lle('', 'z') :s(end)
        r = 'failure'
