...
END";
        ...
        Assert.AreEqual(45, ((IntegerVar)(build.Execute!.IdentifierTable["I2"])).Data);
        Assert.AreEqual(-5, ((IntegerVar)(build.Execute!.IdentifierTable["R2"])).Data);
    }
...
";
        ...
        var build = SetupTests.SetupScript(directives, s);
        Assert.AreEqual(0, build.ErrorCodeHistory.Count);
        Assert.AreEqual("PRO+DUCT", ((StringVar)(build.Execute!.IdentifierTable["R1"])).Data);
        Assert.AreEqual(2.39, ((RealVar)(build.Execute!.IdentifierTable["R2"])).Data);
        Assert.AreEqual("1PRICE", ((StringVar)(build.Execute!.IdentifierTable["R3"])).Data);
        Assert.AreEqual("", ((StringVar)(build.Execute!.IdentifierTable["R4"])).Data);
    }
}
