...
";
        ...
        IntegerVar i = (IntegerVar)build.Execute!.IdentifierTable["A"];
...
";
        ...
        var build = SetupTests.SetupScript(directives, s);
        Assert.AreEqual(0, build.ErrorCodeHistory.Count);
        RealVar r = (RealVar)build.Execute!.IdentifierTable["A"];
...
";
        ...
        var build = SetupTests.SetupScript(directives, s);
        Assert.AreEqual(0, build.ErrorCodeHistory.Count);
        StringVar v = (StringVar)build.Execute!.IdentifierTable["A"];
