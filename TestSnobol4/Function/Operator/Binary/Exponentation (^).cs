...
public class Exponentiation
{
    ...
    public void TEST_Integer_Exponentiation_1()
    {
        ...
        Assert.AreEqual(8L, ((RealVar)build.Execute!.IdentifierTable["A"]).Data);
    }
    ...
    public void TEST_Integer_Exponentiation_2()
    {
        ...
        Assert.AreEqual(0L, ((RealVar)build.Execute!.IdentifierTable["A"]).Data);
    }
    ...
    public void TEST_Integer_Exponentiation_6()
    {
        ...
        Assert.AreEqual(8L, ((IntegerVar)build.Execute!.IdentifierTable["A"]).Data);
    }
    ...
    public void TEST_REAL_Exponentiation_1()
    {
        ...
        Assert.AreEqual(Math.Pow(2.1, 3.1), ((RealVar)build.Execute!.IdentifierTable["A"]).Data);
    }
    ...
    public void TEST_Mixed_Exponentiation_1()
    {
        ...
        Assert.AreEqual(Math.Pow(2, 3.1), ((RealVar)build.Execute!.IdentifierTable["A"]).Data);
    }
    ...
    public void TEST_Mixed_Exponentiation_002()
    {
        ...
        Assert.AreEqual(Math.Pow(2.1, 3), ((RealVar)build.Execute!.IdentifierTable["A"]).Data);
    }
