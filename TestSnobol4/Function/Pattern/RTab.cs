...
n       result = 'fail' 
        ...
        Assert.AreEqual("abc", ((StringVar)build.Execute!.IdentifierTable["TAB1"]).Data);
    }
...
n       result = 'fail' 
        ...
        var build = SetupTests.SetupScript(directives, s);
        Assert.AreEqual("success", ((StringVar)build.Execute!.IdentifierTable["RESULT"]).Data);
        Assert.AreEqual("C", ((StringVar)build.Execute!.IdentifierTable["TEST"]).Data);
    }
...
n       result = 'fail' 
        ...
        var build = SetupTests.SetupScript(directives, s);
        Assert.AreEqual("success", ((StringVar)build.Execute!.IdentifierTable["RESULT"]).Data);
        Assert.AreEqual("****ABCDE", ((StringVar)build.Execute!.IdentifierTable["SUBJECT"]).Data);
    }
